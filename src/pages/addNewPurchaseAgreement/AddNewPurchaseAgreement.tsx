...
const AddNewPurchaseAgreement = () => {
  ...
  const handleCreateAgreement = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        insurerType: form.insuranceType || null,
  ...
  const handleCreateAndSignAgreement = async (isPrintFlow = false) => {
    ...
    try {
      ...
      toast.error("Failed to create purchase agreement");
    } finally {
      setIsCreating(false);
    }
  };
  ...
  return (
    <div className="lg:p-6 p-4 font-plus-jakarta">
      <div className="flex items-center mb-6">
        ...
        >
          <BackArrowIcon />
          <span className="ml-2">Create Purchase Agreement</span>
        </button>
      </div>
...
export default AddNewPurchaseAgreement;
