...
const AddNewUser: React.FC<AddNewUserProps> = ({ open, onClose }) => {
  if (!open) return null;
        ...
        <form className="p-6 flex-1 overflow-y-auto flex flex-col gap-4">
          ...
          <div>
            ...
            <div className="relative">
              <select className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500">
