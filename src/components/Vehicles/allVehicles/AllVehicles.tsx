...
import AddNewVehicle from "../../models/AddNewVehicle";
import FilterVehicle from "../../models/FilterVehicle";
  ...
  return (
    <div className="bg-white rounded-2xl p-6 mt-4 font-sans dashboard-cards font-plus-jakarta">
      <div className="flex lg:flex-row flex-col justify-between lg:items-center mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Alla fordon</h2>
      ...
      {filteredVehicles !== null && (
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg flex justify-between items-center">
          <span className="text-sm text-blue-700">
            Visar {filteredVehicles.length} filtrerade fordon
          </span>
          <button
